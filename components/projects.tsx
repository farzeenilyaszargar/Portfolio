    ...
    return (
        <div className="sm:w-2/3 w-screen px-5 mt-7 flex flex-col items-center">
            ...
            <div className="w-full flex flex-row relative rounded-2xl overflow-hidden ">
                ...
                <div className='absolute top-0 left-0 h-full w-full z-5 bg-background opacity-25'>
                ...
                <div className="absolute top-0 right-0 h-full w-12 pointer-events-none bg-gradient-to-l from-background to-transparent"></div>
                <div className="absolute top-0 left-0 w-full h-6 pointer-events-none bg-gradient-to-b from-background to-transparent"></div>
                <div className="absolute bottom-0 left-0 w-full h-6 pointer-events-none bg-gradient-to-t from-background to-transparent"></div>
